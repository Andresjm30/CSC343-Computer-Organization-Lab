...
-- *****************************************************************************
-- Generated on "11/29/2020 17:57:58"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          mejia_data_mem_Nov6
-- 
...
ENTITY mejia_data_mem_Nov6_vhd_vec_tst IS
END mejia_data_mem_Nov6_vhd_vec_tst;
ARCHITECTURE mejia_data_mem_Nov6_arch OF mejia_data_mem_Nov6_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
...
LOOP
	...
	clock <= '1';
	WAIT FOR 5000 ps;
	IF (NOW >= 90000 ps) THEN WAIT; END IF;
END LOOP;
