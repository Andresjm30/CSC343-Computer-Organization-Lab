...
-- *****************************************************************************
-- Generated on "11/18/2020 02:56:01"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          mejia_arr_mult2_Nov17
-- 
...
ENTITY mejia_arr_mult2_Nov17_vhd_vec_tst IS
END mejia_arr_mult2_Nov17_vhd_vec_tst;
ARCHITECTURE mejia_arr_mult2_Nov17_arch OF mejia_arr_mult2_Nov17_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
...
COMPONENT mejia_arr_mult2_Nov17
	PORT (
...
END mejia_arr_mult2_Nov17_arch;
