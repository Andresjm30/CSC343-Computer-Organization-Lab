...
-- *****************************************************************************
-- Generated on "11/17/2020 22:21:24"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          mejia_arr_mult_Nov16
-- 
...
ENTITY mejia_arr_mult_Nov16_vhd_vec_tst IS
END mejia_arr_mult_Nov16_vhd_vec_tst;
ARCHITECTURE mejia_arr_mult_Nov16_arch OF mejia_arr_mult_Nov16_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
...
COMPONENT mejia_arr_mult_Nov16
	PORT (
